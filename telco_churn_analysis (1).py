...
# -*- coding: utf-8 -*-
"""
Telco Customer Churn — Exploratory Data Analysis & Predictive Modeling
========================================================================

Ανάλυση δεδομένων εγκατάλειψης πελατών (churn) τηλεπικοινωνιακής εταιρείας.
Dataset: https://www.kaggle.com/datasets/blastchar/telco-customer-churn

Τρέχει σε Google Colab ή τοπικά (Jupyter / script). Παράγει:
  1. Καθαρισμό & προετοιμασία δεδομένων
  2. Περιγραφική στατιστική & EDA
  3. Ένα πλήρες σύνολο γραφημάτων (αποθηκεύονται σε ./figures)
  4. Ένα βασικό predictive model (Logistic Regression) με feature importance
  5. Ένα summary report σε CSV (./output/churn_summary.csv)

Author: (το όνομά σου εδώ)
"""
